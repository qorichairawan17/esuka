    ...
    <section class="section d-table w-100">
            ...
            <div class="row align-items-center">
                <div class="col-lg-5 col-md-5 mt-4 pt-2 mt-sm-0 pt-sm-0">
                    <div class="position-relative">
                        <img src="{{ asset('assets/images/Piagam-Esuka.png') }}" class="rounded img-fluid mx-auto d-block" alt="">
                    </div>
                </div>
        ...
        <div class="container mt-100">
            <div class="row align-items-center">
                ...
                <div class="col-lg-5 col-md-5 mt-4 pt-2 mt-sm-0 pt-sm-0">
                    <div class="position-relative">
                        <img src="{{ asset('assets/images/sk-penetapan.jpg') }}" class="rounded img-fluid mx-auto d-block" alt="">
                    </div>
                </div>
