(function (a, b) {
    ...
    return function (a) {
        var b = Math.abs,
            ...
            D = {
                        ...
                        (d.style.opacity = "0"),
                            ...
                            c.captions &&
                                ...
                                a.getAttribute(c.captionAttribute)
                                    ? (f.textContent = a.getAttribute(
                                          c.captionAttribute
                                      ))
                                    : "img" === c.captionsSelector &&
                                      h &&
                                      h.getAttribute(c.captionAttribute) &&
                                      (f.textContent = h.getAttribute(
                                          c.captionAttribute
                                      )),
                                f.textContent &&
                ...
                html: {
                    ...
                    onLeave: function (a) {
                        ...
                        b &&
                            (!b.paused && b.pause(),
                            0 < b.readyState &&
                                b.setAttribute("data-time", b.currentTime));
                    },
                    ...
                    init: function (a, b) {
                        ...
                        c.setAttribute("frameborder", "0"),
                            ...
                            a.getAttribute("data-width") &&
                                (c.style.maxWidth =
                                    a.getAttribute("data-width") + "px"),
                            a.getAttribute("data-height") &&
                                (c.style.maxHeight =
                                    a.getAttribute("data-height") + "px"),
                            b.appendChild(c),
                ...
                youtube: {
                    ...
                    init: function (a, b) {
                        ...
                        b.appendChild(c),
                            (w[x] = new window.YT.Player(c, {
                                ...
                                playerVars: {
                                    controls:
                                        a.getAttribute("data-controls") || 1,
                                    rel: 0,
                                    playsinline: 1,
                                },
                            })),
                    ...
                    onLoad: function (a) {
                        c.autoplayVideo &&
                            w[a.getAttribute("data-player")].playVideo();
                    },
                    onLeave: function (a) {
                        1 ===
                            w[a.getAttribute("data-player")].getPlayerState() &&
        ...
        var E = function (a) {
                ...
                if (!b)
                    throw new Error(
                        "Ups, I can't find the selector " + c.selector + "."
                    );
            ...
            N = function (a, b) {
                if (((B = null === B ? A : B), ra() || a || (a = 0), ra())) {
                    ...
                    if (a === z[B].currentIndex)
                        throw new Error(
                            "Ups, slide " + a + " is already selected."
                        );
                }
            ...
            O = function (a) {
                ...
                c.hideScrollbar &&
                    ...
                    o.focus();
                var b =
                        z[B].sliderElements[z[B].currentIndex].querySelector(
                            "[data-type]"
                        ),
            ...
            W = function () {
                j.textContent =
                    z[B].currentIndex + 1 + "/" + z[B].elementsLength;
            },
            X = function (a) {
                var b = null;
                c.nav
            ...
            aa = function (a) {
                a.target === g
                    ...
                    ? S()
                    : (a.target === i ||
                          ("tobii__slider-slide" === a.target.className &&
                              c.docClose)) &&
                      O(),
                    a.stopPropagation();
            },
                ...
                9 === a.keyCode || "Tab" === a.code
                    ? a.shiftKey
                        ? document.activeElement === p &&
                          (q.focus(), a.preventDefault())
                        : document.activeElement === q &&
                          (p.focus(), a.preventDefault())
            ...
            ga = function (a) {
                a.preventDefault(),
                    n && ((k.endX = a.pageX), (k.endY = a.pageY), ia());
            },
            ha = function (a) {
                a.stopPropagation(),
                    (n = !1),
            ...
            wa = function (a) {
                ...
                if (a) {
                    if (a && !Object.prototype.hasOwnProperty.call(z, a))
                        throw new Error(
                            "Ups, I don't have a group called \"" + a + '".'
                        );
                    B = a;
                }
            };
