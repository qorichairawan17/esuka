...
class SuratKuasaAdvokatRequest extends FormRequest
{
    ...
    public function rules($isUpdate = false): array
    {
        ...
        return [
            ...
            'kta' => [$fileRule, 'file', 'mimes:pdf', 'max:2048'],
            'bas' => [$fileRule, 'file', 'mimes:pdf', 'max:2048'],
    ...
    public function messages()
    {
        return [
            ...
            'kta.max' => 'Ukuran Kartu Tanda Anggota tidak boleh lebih dari 2MB.',
            ...
            'bas.max' => 'Ukuran Berita Acara Sumpah tidak boleh lebih dari 2MB.',
